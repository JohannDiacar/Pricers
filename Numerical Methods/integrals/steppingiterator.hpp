...
namespace QuantLib {
    ...
    */
    ...
    class step_iterator {
      private:
        Iterator base_{};
        // a size_t would mess up integer division in distance_to
        BigInteger step_{};
      ...
      public:
        ...
        step_iterator(const step_iterator<OtherIterator>& i,
                      ...
                      <OtherIterator, Iterator>::value>::type* = 0)
        ...
        */
        ...
        step_iterator& operator+=(size_t n) {
            base_ += n * step_;
            return *this;
        }
        ...
        friend step_iterator operator+(const step_iterator& i, size_t n) {
            return step_iterator(i.base_ + n * i.step_, i.step_);
        }

        friend step_iterator operator+(size_t n, const step_iterator& i) {
            return step_iterator(i.base_ + n * i.step_, i.step_);
        }
