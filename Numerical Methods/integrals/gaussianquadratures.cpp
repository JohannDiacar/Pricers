...
namespace QuantLib {
    ...
    namespace detail {
        ...
        GaussianQuadratureIntegrator<Integration>::GaussianQuadratureIntegrator(
            size_t n)
        : Integrator(Null<double>(), n),
          integration_(ext::make_shared<Integration>(n))
         {  }

        template <class Integration>
        double GaussianQuadratureIntegrator<Integration>::integrate(
            ...
            return c1*integration_->operator()(
                [c1, c2, f](double x) { return f(c1*x+c2);});
        }
    ...
    void TabulatedGaussLegendre::order(size_t order) {
        switch(order) {
          case(6):
    ...
    /* order 6 */
    const double TabulatedGaussLegendre::x6[3] = { 0.238619186083197,
                                                 0.661209386466265,
                                                 0.932469514203152 };

    const double TabulatedGaussLegendre::w6[3] = { 0.467913934572691,
                                                 0.360761573048139,
                                                 0.171324492379170 };

    const size_t TabulatedGaussLegendre::n6 = 3;

    /* order 7 */
    const double TabulatedGaussLegendre::x7[4] = { 0.000000000000000,
                                                 0.405845151377397,
                                                 0.741531185599394,
                                                 0.949107912342759 };

    const double TabulatedGaussLegendre::w7[4] = { 0.417959183673469,
                                                 0.381830050505119,
                                                 0.279705391489277,
                                                 0.129484966168870 };

    const size_t TabulatedGaussLegendre::n7 = 4;

    /* order 12 */
    const double TabulatedGaussLegendre::x12[6] = { 0.125233408511469,
                                                  0.367831498998180,
                                                  0.587317954286617,
                                                  0.769902674194305,
                                                  0.904117256370475,
    ...
    const double TabulatedGaussLegendre::w12[6] = { 0.249147045813403,
                                                  0.233492536538355,
                                                  0.203167426723066,
                                                  0.160078328543346,
                                                  0.106939325995318,
    ...
    const size_t TabulatedGaussLegendre::n12 = 6;

    /* order 20 */
    const double TabulatedGaussLegendre::x20[10] = { 0.076526521133497,
                                                   0.227785851141645,
                                                   0.373706088715420,
                                                   0.510867001950827,
                                                   0.636053680726515,
    ...
    const double TabulatedGaussLegendre::w20[10] = { 0.152753387130726,
                                                   0.149172986472604,
                                                   0.142096109318382,
                                                   0.131688638449177,
                                                   0.118194531961518,
    ...
    const size_t TabulatedGaussLegendre::n20 = 10;
