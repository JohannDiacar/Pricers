...
#pragma GCC diagnostic pop
        ...
        size_t order() const { return x_.size(); }
    ...
    */
    class GaussLaguerreIntegration : public GaussianQuadrature {
      public:
        explicit GaussLaguerreIntegration(size_t n, double s = 0.0)
    ...
    */
    class GaussHermiteIntegration : public GaussianQuadrature {
      public:
        explicit GaussHermiteIntegration(size_t n, double mu = 0.0)
    ...
    */
    class GaussJacobiIntegration : public GaussianQuadrature {
      public:
        GaussJacobiIntegration(size_t n, double alpha, double beta)
    ...
    */
    class GaussHyperbolicIntegration : public GaussianQuadrature {
      public:
        explicit GaussHyperbolicIntegration(size_t n)
    ...
    */
    class GaussLegendreIntegration : public GaussianQuadrature {
      public:
        explicit GaussLegendreIntegration(size_t n)
    ...
    */
    class GaussChebyshevIntegration : public GaussianQuadrature {
      public:
        explicit GaussChebyshevIntegration(size_t n)
    ...
    */
    class GaussChebyshev2ndIntegration : public GaussianQuadrature {
      public:
        explicit GaussChebyshev2ndIntegration(size_t n)
      : GaussianQuadrature(n, GaussJacobiPolynomial(0.5, 0.5)) {}
    };
    ...
    */
    class GaussGegenbauerIntegration : public GaussianQuadrature {
      public:
        GaussGegenbauerIntegration(size_t n, double lambda)
    ...
    namespace detail {
        ...
        class GaussianQuadratureIntegrator: public Integrator {
          public:
            explicit GaussianQuadratureIntegrator(size_t n);

            ext::shared_ptr<Integration> getIntegration() const { return integration_; }

          private:
            double integrate(const ext::function<double (double)>& f,
                                           double a,
    ...
    class TabulatedGaussLegendre {
      public:
        explicit TabulatedGaussLegendre(size_t n = 20) { order(n); }
        template <class F>
        double operator() (const F& f) const {
            ...
            const size_t isOrderOdd = order_ & 1;
      ...
      private:
        ...
        static const double w6[3];
        static const double x6[3];
        static const size_t n6;

        static const double w7[4];
        static const double x7[4];
        static const size_t n7;

        static const double w12[6];
        static const double x12[6];
        static const size_t n12;

        static const double w20[10];
        static const double x20[10];
        static const size_t n20;
    };
