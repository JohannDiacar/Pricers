...
namespace QuantLib {
    ...
    */
    ...
    bool close(Real x, Real y, size_t n);
    ...
    */
    ...
    bool close_enough(Real x, Real y, size_t n);
    ...
    inline bool close(Real x, Real y, size_t n) {
        // Deals with +infinity and -infinity representations etc.
        if (x == y)
            return true;
    ...
    inline bool close_enough(Real x, Real y, size_t n) {
        // Deals with +infinity and -infinity representations etc.
        if (x == y)
            return true;
